...
import { getTrainerProfileById, updateTrainerProfile } from "../../api";
...
const TrainerProfile = () => {
  ...
  useEffect(() => {
    const fetchTrainerProfile = async () => {
      setLoading(true);
      try {
        const response = await getTrainerProfileById(trainerId);
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      const updatedProfileResponse = await getTrainerProfileById(trainerId);
